...
template<> struct transposed_type<row_major>
{
    typedef col_major   t_type;
};
template<> struct transposed_type<col_major>
{
    typedef row_major   t_type;
};
template<> struct transposed_type<row_and_col>
{
    typedef col_and_row t_type;
};
template<> struct transposed_type<col_and_row>
{
...
template <typename L> inline bool is_const_reference(L)
{
    return false;
}
...
template <typename T> inline T abs_sqr(T a)
{
    return a*a;
}
...
template <typename T> inline T pos(T a)
{
    return (a < T(0)) ? T(0) : a;
}
template <typename T> inline T neg(T a)
{
...
template <typename T> inline T conj(T a)
{
    return a;
}
...
template <typename T> inline T real(T a)
{
    return a;
}
template <typename T> inline T real(std::complex<T> a)
{
    return a.real();
}
template <typename T> inline T imag(T )
{
    return T(0);
}
template <typename T> inline T imag(std::complex<T> a)
{
    return a.imag();
}
...
template <typename T> inline T conj_product(T a, T b)
{
    return a * b;
}
...
template <typename T> inline bool is_complex(T)
{
    return false;
}
...
template<> struct strongest_numeric_type<int,float>
{
    typedef float T;
};
template<> struct strongest_numeric_type<float,int>
{
    typedef float T;
};
template<> struct strongest_numeric_type<long,float>
{
    typedef float T;
};
template<> struct strongest_numeric_type<float,long>
{
    typedef float T;
};
template<> struct strongest_numeric_type<long,double>
{
    typedef double T;
};
template<> struct strongest_numeric_type<double,long>
{
    typedef double T;
};
...
*/
template<typename T> inline T safe_divide(T a, T b)
{
    return a/b;
}
...
template <typename T> struct cast_char_type
{
    typedef T return_type;
};
template <> struct cast_char_type<signed char>
{
