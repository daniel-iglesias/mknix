...
public :
    ...
    T operator +()
    {
        return  T(*this);      // necessary for unknow reason
    }
    T operator -()
    {
        return -T(*this);      // necessary for unknow reason
    ...
    T operator +(T v)
    {
        return T(*this)+ v;    // necessary for unknow reason
    }
    T operator -(T v)
    {
        return T(*this)- v;    // necessary for unknow reason
...
bool operator ==(T v, const ref_elt_vector<T, V> &re)
{
    return (v==T(re));
}
template<typename T, typename V> inline
...
template<typename T, typename V> inline
T operator +(const ref_elt_vector<T, V> &re)
{
    return T(re);
}
template<typename T, typename V> inline
...
template<typename T, typename V> inline
T operator +(const ref_elt_vector<T, V> &re, T v)
{
    return T(re)+ v;
}
template<typename T, typename V> inline
...
template<typename T, typename V> inline
T sqr(const ref_elt_vector<T, V> &re)
{
    return gmm::sqr(T(re));
}
template<typename T, typename V> inline
...
template<typename T, typename V> inline
T conj(const ref_elt_vector<T, V> &re)
{
    return gmm::conj(T(re));
}
template<typename T, typename V> std::ostream &operator <<
(std::ostream &o, const ref_elt_vector<T, V> &re)
{
    o << T(re);
    return o;
}
...
template<typename T>  void wsvector<T>::clean(double eps)
{
    ...
    {
        ++itf;
        if (gmm::abs(it->second) <= eps) this->erase(it);
        it = itf;
    }
}
...
(std::ostream &o, const wsvector<T>& v)
{
    gmm::write(o,v);
    return o;
}
...
template<typename T> std::ostream &operator <<
(std::ostream &o, const rsvector<T>& v)
{
    gmm::write(o,v);
    return o;
}
...
template<typename T> std::ostream &operator <<
(std::ostream &o, const slvector<T>& v)
{
    gmm::write(o,v);
    return o;
}
