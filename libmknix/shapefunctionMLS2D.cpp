...
{
//  double radius;
    double rr2, xn, yn, xp, yp, qq;
    //For case 1:
    double s_i, ss_i, xx_i, yy_i, wx(0.), wy(0.), wx_x(0.), wy_y(0.);
...
void ShapeFunctionMLS::computePhi(double xp, double yp)
{
